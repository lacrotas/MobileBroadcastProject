    ...
    return (
        <section className="expert_filter">
            <div className="expert_filter_container">
                ...
                <p className="expert_filter_paragraph paragraph_text">Станьте одним из экспертов по мобильной разработке iOS, Android, Kotlin, Аврора и других кроссплатформ. Каждый из экспертов отвечает за определённое направление, активно участвует в его развитии и популяризации, а также делится своей экспертизой с участниками нашего сообщества.</p>
