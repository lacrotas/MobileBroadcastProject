...
function MeatingCard({ location, data, time, cityId, meatingFilter, addMeating, meatingId, isDelete, deleteMeating }) {
    ...
    return (
        <>
            {
                checkName() ?
                    <div className="add_meating_card">
                        ...
                        <div className="card_container-hover">
                            {isDelete ?
                                <button className="card_button button" onClick={() => deleteMeating(meatingId)}>Удалить встречу</button>
                                :
                                <button className="card_button button" onClick={() => addMeating(meatingId)}>Добавить встречу</button>
                            }
                        </div>
                    </div >
                    : <></>
